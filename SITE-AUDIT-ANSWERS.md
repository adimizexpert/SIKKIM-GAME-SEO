...
- **Destination:** Official registration URL **`https://www.jaiclub00.com/#/register?invitationCode=16454276749`** (used in CTA buttons and guides).
- **Model:** Invite/referral code **16454276749** is embedded in register links, so the site is acting as an **affiliate/referral** channel for Sikkim Game (sikkimgg.cc), not a separate “casino brand” — it promotes this single gaming brand.
...
| **Affiliate program** | Sikkim Game (bigmumbaia.com), invite code 16454276749 |
