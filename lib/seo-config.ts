...
export const defaultSEO = {
  ...
  additionalMetaTags: [
    ...
    {
      name: 'keywords',
      content: 'Sikkim Game, Sikkim Game Login, Sikkim Game Register, Online Game, Sikkim Game Login Page, Sikkim Game Registration, Play Sikkim Game',
    },
    {
      name: 'robots',
...
export const loginPageSEO = {
  ...
  additionalMetaTags: [
    {
      name: 'keywords',
      content: 'Sikkim Game Login, Login Sikkim Game, Sikkim Game Sign In, Sikkim Game Login Page, How to Login Sikkim Game',
    },
  ],
};
...
export const registerPageSEO = {
  ...
  additionalMetaTags: [
    {
      name: 'keywords',
      content: 'Sikkim Game Registration, Register Sikkim Game, Sikkim Game Sign Up, Create Sikkim Game Account, Sikkim Game Registration Page',
    },
  ],
};
